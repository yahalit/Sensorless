...
JustClimb = 0 ; 
IgnoreJunction = 1; 
ShelfHeight = 1.2  ; % 2.075 ; % 1.58 ; % 1.093 ; 
% RecTime = 40 ;  
% MaxRecLen = 1400 ; 
ClimbDir = ClimbDirOpt.Left ; 
ShelfRun = -0.35 ; 
DoShelfTravel = 0 ; 
...
if stat   
    msgbox({'\fontsize{14}Use the gorund nav menu','to crab the robot brfore start'},CreateStruct) ;
    return
end
...
if bExetndedWidth
    ...
    TrackWidth = RetractedTrackWidth ; %#ok<UNRCH> 
end
