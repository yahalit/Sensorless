...
if RecSw == 1 
    RecNames = {'ArcDistance0','ArcDistance1','SpeedRatio','RwSpeedCmdAxis','LwSpeedCmdAxis',...
        'RightWheelEncoder','LeftWheelEncoder','EulerRoll','NeckOuterPos','RWheelEncSpeed','LWheelEncSpeed','FollowerScale','lDebug4'} ;
else
...
figure(3) 
plot( r.ArcDistance0, r.RwSpeedCmdAxis * Geom.Calc.MotEncoder2MeterShelf , r.ArcDistance0 , r.RWheelEncSpeed * Geom.Calc.WheelEncoder2MeterShelf); legend('Rcmd','Ract') ; 
figure(4) 
plot( r.ArcDistance0, r.LwSpeedCmdAxis * Geom.Calc.MotEncoder2MeterShelf , r.ArcDistance0 , r.LWheelEncSpeed * Geom.Calc.WheelEncoder2MeterShelf) ; legend('Lcmd','Lact') ; 
