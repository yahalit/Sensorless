...
qPre = [1,0,0,0] ; %[ -1.220044113174583e-01     6.965019193218928e-01     6.984135802425090e-01     1.105371925319274e-01] ; 
...
w = -[r.RawW0; r.RawW1 ; r.RawW2] ; 
q = [r.RawQuat0 ; r.RawQuat1 ; r.RawQuat2 ; r.RawQuat3 ] ; 
plot( t , w ) ; legend('x','y','z' ) ; ylabel('P') ; grid on 
...
figure(2) ; 
subplot( 3,1,2) ; 
plot( t , yyy , t , ppp , t , rrr ) ; legend('Y','P','R' ) ; ylabel('P Euler') ; grid on 
...
w = [r.RawW0; r.RawW1 ; r.RawW2] ; 
q = [r.RawQuat0 ; r.RawQuat1 ; r.RawQuat2 ; r.RawQuat3 ] ; 
plot( t , w ) ; legend('x','y','z' ) ; ylabel('R') ; grid on 
...
figure(2) ; 
subplot( 3,1,3) ; 
plot( t , yyy , t , ppp , t , rrr ) ; legend('Y','P','R' ) ; ylabel('R Euler') ; grid on 
