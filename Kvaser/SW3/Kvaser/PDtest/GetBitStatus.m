...
val = KvaserCom( 8 , [1536+TargetCanId2 ,1408+TargetCanId2 ,hex2dec('2104') ,1,DataType.long,0,100] ); % Get status
val2 = KvaserCom( 8 , [1536+TargetCanId2 ,1408+TargetCanId2 ,hex2dec('2104') ,2,DataType.long,0,100] ); % Get status
val3 = KvaserCom( 8 , [1536+TargetCanId2 ,1408+TargetCanId2 ,hex2dec('2104') ,3,DataType.long,0,100] ); % Get status
if ( val < 0) 
    val = val + 2^32 ; 
end 
s.raw = val ; 
