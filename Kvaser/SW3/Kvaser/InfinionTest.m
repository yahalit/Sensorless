...
RecStruct = struct('Gap',8,'Len',300) ; 

% Set the 12V supply on 
stat = KvaserCom( 7 , [1536+124 ,1408+124 ,8196,1,DataType.short,0,100], 1 ); % Set 12V on  
if stat , error ('Sdo failure') ; end 

% Set the 12V supply off
stat = KvaserCom( 7 , [1536+124 ,1408+124 ,8196,1,DataType.short,0,100], 0 ); % Set 12V off  
if stat , error ('Sdo failure') ; end 

% Set the FAN on 
stat = KvaserCom( 7 , [1536+124 ,1408+124 ,8195,256,DataType.short,0,1], 1 ); % FAN on 
if stat , error ('Sdo failure') ; end 

% Set the FAN off
stat = KvaserCom( 7 , [1536+124 ,1408+124 ,8195,256,DataType.short,0,1], 0 ); % FAN off
if stat , error ('Sdo failure') ; end 

% Set the wheel brake 
stat = KvaserCom( 7 , [1536+124 ,1408+124 ,8195,8,DataType.short,0,1], 900 ); % Wheel brake
if stat , error ('Sdo failure') ; end 
...
if stat , error ('Sdo failure') ; end 
stat = KvaserCom( 7 , [1536+124 ,1408+124 ,8192,11,DataType.short,0,100], 22 );  
if stat , error ('Sdo failure') ; end 
stat= KvaserCom( 7 , [1536+124 ,1408+124 ,8192,12,DataType.short,0,100], 19 ); 
if stat , error ('Sdo failure') ; end 
stat= KvaserCom( 7 , [1536+124 ,1408+124 ,8192,13,DataType.short,0,100], 20 ); 
if stat , error ('Sdo failure') ; end 
stat= KvaserCom( 7 , [1536+124 ,1408+124 ,8192,14,DataType.short,0,100], 25 ); 
if stat , error ('Sdo failure') ; end 
