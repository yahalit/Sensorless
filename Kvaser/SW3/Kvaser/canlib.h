...
// Just in case someone is trying to develop 16-bit code.
#if !defined(__WIN32__)
#error This version of canlib.h can be used only in a 32-bit environment.
#endif
...
#define canOBJBUF_TYPE_PERIODIC_TX              0x02 // not implemented right now
