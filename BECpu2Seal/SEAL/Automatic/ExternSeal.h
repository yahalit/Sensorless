...
{.desc={.func = ((voidFunc)0UL), .FunType = E_Func_None, .Priority=0 , .nInts = 1, .Ts=0.001 ,.Algn=0, .Ticker = 0}},
{.desc={.func = ((voidFunc)0UL), .FunType = E_Func_None, .Priority=0 , .nInts = 1, .Ts=0.001 ,.Algn=0, .Ticker = 0}}};
const short unsigned * BufferPtrs[16] = {(bPtr)&G_DrvCommandBuf,(bPtr)&G_FeedbackBuf,(bPtr)&G_SetupReportBuf,(bPtr)&G_CANCyclicBuf_in,(bPtr)&G_CANCyclicBuf_out,(bPtr)&G_UartCyclicBuf_in,(bPtr)&G_UartCyclicBuf_out,(bPtr)&G_SEALVerControl,0U,0U,0U,0U,0U,0U,0U,0U};
#endif
