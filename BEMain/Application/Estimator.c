...
/*
    ...
    SLessData.I[1] = ClaState.Analogs.PhaseCur[1];
    SLessData.I[2] = ClaState.Analogs.PhaseCur[2];

    SLessData.V[0] = (float)ClaState.Analogs.PhaseVoltMeas[0];
    SLessData.V[1] = (float)ClaState.Analogs.PhaseVoltMeas[1];
    SLessData.V[2] = (float)ClaState.Analogs.PhaseVoltMeas[2];
    ...
    {
        SLessState.ThetaEst = str_base.CommAngle * InvPI2; //  (float)(*ThtM)* SysPars.npp; //  FieldFilter.ThetaHat;
    }
 PaicuPU();
}
*/
